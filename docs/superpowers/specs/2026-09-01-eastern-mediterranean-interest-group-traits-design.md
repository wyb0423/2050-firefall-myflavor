...
| BYZ 新罗马学社 | `ig_trait_ffpa_byz_new_rome_academies` | New Rome Academies／新罗马学苑 | 忠诚 | `ig_trait_propagandists`：移民吸引力 `+15%` | `state_pop_qualifications_mult = 0.05`；`state_education_access_add = 0.05` | `propagandists.dds` |
