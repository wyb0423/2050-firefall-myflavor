...
- `BYZ` 获得克制的利益集团名称与有限专属 trait、帝国/执政官政体称号、动态国名和基于原版四字母十字旗的简约动态旗帜；取得奥斯曼共同体身份的 `TUR` 同样获得有限的利益集团名称与专属 trait。`TUR` 保留原版 Tag、国旗与政体视觉，并获得按君主制/共和国路径区分的专属政体称号。两国政体说明还会显示可供事件与日志复用的正式政府名称。
